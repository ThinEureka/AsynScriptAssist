...
using Eureka.AsynScriptAssist;

namespace AsynScriptAssist_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new AsynScriptAssistPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Eureka.AsynScriptAssist.GuidList.guidAsynScriptAssistCmdSet, (int)Eureka.AsynScriptAssist.PkgCmdIDList.cmdidAsynScriptAssist);
